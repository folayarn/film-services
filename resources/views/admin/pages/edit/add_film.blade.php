...
<label class="label-control">
                ...
                name="title" value={{$film->title}} required>
              </div>
              <div class="form-group">
                        <label class="label-control">
...
<label class="label-control">
                ...
                name="length"
                value={{$film->movieLength}}  required>
              </div>
               <div class="form-group">
<label class="label-control">
                              Release Year </label>
                <input type="date" class="form-control" value={{$film->releaseYear}} id="year"
                name="year"
              ...
              <label class="label-control">
               ...
               <div class="form-group">
                        <label class="label-control">
                              The Director </label>
                        <select class="form-control" id='ques_drop2' name="director" value={{$film->director_id}} required>
